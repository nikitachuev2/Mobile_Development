...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String? _validateEmail(String? value) {
    ...
    if (text.isEmpty) return 'Введите электронную почту.';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Флажок: показать повторный пароль
                  CheckboxListTile(
                    value: _showPasswordConfirm,
                    onChanged: (v) =>
                        setState(() => _showPasswordConfirm = v ?? false),
                    title: const Text('Показать повторный пароль'),
                    controlAffinity: ListTileControlAffinity.leading,
                  ),
